...
const TRACKED_OPTIONS: { value: TrackedBefore; icon: IconName; label: string; sub: string }[] = [
  { value: 'yes',   icon: 'yes', label: 'Yes',           sub: 'I know the drill' },
  { value: 'tried', icon: 'tried', label: 'Tried briefly', sub: 'Gave up or lost track' },
  { value: 'no',    icon: 'never', label: 'Never',         sub: 'This is new for me' },
]

const CHALLENGE_OPTIONS = [
  { id: 'consistency',  label: 'Staying consistent',    icon: 'consistency' as IconName },
  { id: 'logging_time', label: 'Logging feels tedious', icon: 'logging_time' as IconName },
  { id: 'social',       label: 'No accountability',     icon: 'social' as IconName },
  { id: 'accuracy',     label: 'Estimating portions',   icon: 'accuracy' as IconName },
  { id: 'motivation',   label: 'Losing motivation',     icon: 'motivation' as IconName },
  { id: 'complexity',   label: 'Too complicated',       icon: 'complexity' as IconName },
]
